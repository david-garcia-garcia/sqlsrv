...
class Statement extends PDOStatement implements \Countable {
   ...
   *
   * @see https://msdn.microsoft.com/en-us/library/ms714687(v=vs.85).aspx
   *
   * @var array
   */
  protected $INTEGRITY_VIOLATION_CONSTRAINT_CODES = ['23000', '40002'];
   ...
   * @var array
   */
  protected $CONNECTION_FAILED_CODES = ['08S01', '08001', '08002', '08003', '08007'];
